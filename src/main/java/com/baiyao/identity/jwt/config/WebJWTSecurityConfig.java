package com.baiyao.identity.jwt.config;

import com.baiyao.identity.jwt.filter.JWTAuthenticationFilter;
import com.baiyao.identity.jwt.filter.JWTLoginFilter;
import com.baiyao.identity.jwt.provider.MyAuthenticationProvider;
import com.baiyao.identity.jwt.utils.MyPasswordEncoder;
 ...
 * @author feng
 * @version 1.0
 * @date 2021/11/16 下午3:29
 */
@Configuration
@EnableWebSecurity //1: 加载WebSecurityConfiguration配置类, 配置安全认证策略。2: 加载AuthenticationConfiguration, 配置了认证信息
