-- 用户
INSERT INTO sys_user (id, account, username, `password`,create_time,update_time,create_user, update_user) VALUES (1, 'user1', '用户1', '$2a$10$47lsFAUlWixWG17Ca3M/r.EPJVIb7Tv26ZaxhzqN65nXVcAhHQM4i',now(),now(),1,1);
INSERT INTO sys_user (id, account, username, `password`,create_time,update_time,create_user, update_user) VALUES (2, 'user2', '用户2', '$2a$10$uSLAeON6HWrPbPCtyqPRj.hvZfeM.tiVDZm24/gRqm4opVze1cVvC',now(),now(),1,1);-- 角色
INSERT INTO sys_role (id, role_name, role_description) VALUES (1, 'admin', '管理员，拥有所有权限');
INSERT INTO sys_role (id, role_name, role_description) VALUES (2, 'user', '普通用户，拥有部分权限');
-- 权限
